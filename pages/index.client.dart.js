...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    _SymmetricEdgeInsets: function _SymmetricEdgeInsets(t0) {
      this.vertical = t0;
    },
    ...
    _BoxStyles: function _BoxStyles(t0) {
      this.padding = t0;
    },
    _extension_0__prefixed_closure: function _extension_0__prefixed_closure(t0) {
      this.prefix = t0;
    },
    Index: function Index(t0) {
      this.key = t0;
    },
    SimpleCard: function SimpleCard(t0, t1, t2) {
      this.title = t0;
      this.message = t1;
      this.key = t2;
    },
    ...
    main() {
      var $async$goto = 0,
        ...
        $async$returnValue, t1, t2, t3, t4, stateData;
  ...
  A.BrowserDomRenderer.prototype = {
    renderNode$7(element, tag, id, classes, styles, attributes, events) {
      var t1, data, attributesToRemove, elem, toHydrate, t2, _i, e, nodes, old, t3, child, t4, t5, t6, t7, t8;
      ...
      A._extension_1_clearOrSetAttribute(t1, "class", classes == null || classes.length === 0 ? null : (classes && B.JSArray_methods).join$1(classes, " "));
      t1 = elem._readLocal$0();
      A._extension_1_clearOrSetAttribute(t1, "style", styles == null || styles.__js_helper$_length === 0 ? null : styles.get$entries(styles).map$1$1(0, new A.BrowserDomRenderer_renderNode_closure(), type$.String).join$1(0, "; "));
      t1 = attributes == null;
  ...
  A.ComponentsBinding_attachRootComponent_closure.prototype = {
    call$0() {
      ...
      element._attach$0();
      element.super$__RootElement_SingleChildElement_RenderElement$_firstBuild(_null);
  ...
  A.DomElement.prototype = {
    ...
    renderNode$1(renderer) {
      ...
      if (t5 == null)
        ...
        t5 = A._extension_0__prefixed(t5.padding.get$styles(), "padding");
        t6.addAll$1(0, t5);
        t5 = t6;
      }
  ...
  A.SingleChildElement.prototype = {
    ...
    performRebuild$0() {
      ...
      try {
        built = type$._Root._as(A.Element.prototype.get$component.call(_this)).child;
      } catch (exception) {
        e = A.unwrapException(exception);
        st = A.getTraceFromException(exception);
  ...
  A._SymmetricEdgeInsets.prototype = {
    get$styles() {
      ...
      t3 = t2._unit$_value;
      t2 = t2._unit;
      t1.$indexSet(0, "top", A.NumberString_get_numstr(t3) + t2);
      t1.$indexSet(0, "bottom", A.NumberString_get_numstr(t3) + t2);
      return t1;
    },
    $isEdgeInsets: 1
  };
  A._Unit.prototype = {
    $eq(_, other) {
      ...
      if (other == null)
        return false;
      if (_this !== other) {
        t1 = _this._unit$_value;
        if (t1 === 0)
          t2 = other instanceof A._PixelsUnit && other._unit$_value === 0;
        else
          t2 = false;
        if (!t2)
          t1 = other instanceof A._PixelsUnit && A.getRuntimeTypeOfDartObject(_this) === A.getRuntimeTypeOfDartObject(other) && _this._unit === other._unit && t1 === other._unit$_value;
        else
          t1 = true;
      } else
        t1 = true;
    ...
    get$hashCode(_) {
      ...
      return t1 === 0 ? 0 : B.JSString_methods.get$hashCode(this._unit) ^ B.JSInt_methods.get$hashCode(t1);
    },
    $isUnit: 1
  };
  A._PixelsUnit.prototype = {};
  A._BoxStyles.prototype = {$isStyles: 1};
  ...
  A.Index.prototype = {
    build$1(context) {
      return new A._SyncStarIterable(this.build$body$Index(context), type$._SyncStarIterable_Component);
    },
    build$body$Index($async$context) {
      return function() {
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                $async$goto = 2;
                return $async$iterator._async$_current = new A.DomComponent("div", null, null, new A._BoxStyles(new A._SymmetricEdgeInsets(new A._PixelsUnit("px", 30))), null, null, new A.SimpleCard("ChitChat", "You have a new message!", null), null, null), 1;
              case 2:
                // after yield
                // implicit return
                return 0;
  ...
  A.SimpleCard.prototype = {
    build$1(context) {
      return new A._SyncStarIterable(this.build$body$SimpleCard(context), type$._SyncStarIterable_Component);
    },
    build$body$SimpleCard($async$context) {
      var $async$self = this;
      return function() {
        var context = $async$context;
        var $async$goto = 0, $async$handler = 1, $async$currentError, t8, t1, t2, t3, t4, t5, t6, t7;
        return function $async$build$1($async$iterator, $async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                t2 = A._setArrayType("p-6 max-w-sm mx-auto bg-white rounded-xl shadow-lg flex items-center space-x-4".split(" "), t1);
                t3 = A._setArrayType(["shrink-0"], t1);
                t4 = A._setArrayType("h-12 w-12".split(" "), t1);
                t5 = $async$self.title;
                t6 = type$.String;
                t7 = A.LinkedHashMap_LinkedHashMap$of(A.LinkedHashMap_LinkedHashMap$_empty(t6, t6), t6, t6);
                t7.$indexSet(0, "alt", t5 + " Logo");
                t7.$indexSet(0, "src", "/img/logo.svg");
                t8 = type$.JSArray_Component;
                t3 = A.div(A._setArrayType([new A.DomComponent("img", null, t4, null, t7, null, null, null, null)], t8), t3);
                t7 = A._setArrayType("text-xl font-medium text-black".split(" "), t1);
                t8 = A._setArrayType([A.div(A._setArrayType([t3, A.div(A._setArrayType([A.div(A._setArrayType([new A.Text(t5, false, null)], t8), t7), new A.DomComponent("p", null, A._setArrayType(["text-slate-500"], t1), null, null, null, null, A._setArrayType([new A.Text($async$self.message, false, null)], t8), null)], t8), null)], t8), t2)], t8);
                t1 = A.LinkedHashMap_LinkedHashMap$of(A.LinkedHashMap_LinkedHashMap$_empty(t6, t6), t6, t6);
                t1.$indexSet(0, "href", "/hello");
                $async$goto = 2;
                return $async$iterator._async$_current = new A.DomComponent("a", null, null, null, t1, null, null, t8, null), 1;
              case 2:
                // after yield
                // implicit return
                return 0;
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Converter, A.Iterable, A.CastIterator, A.MapBase, A.Closure, A.Error, A.ListIterator, A.MappedIterator, A.FixedLengthListMixin, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.ExceptionAndStackTrace, A._StackTrace, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.JSSyntaxRegExp, A._MatchImplementation, A._Cell, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A._AsyncAwaitCompleter, A._SyncStarIterator, A.AsyncError, A._FutureListener, A._Future, A._AsyncCallbackEntry, A._StreamIterator, A._Zone, A.SetBase, A._HashSetIterator, A._LinkedHashSetCell, A._LinkedHashSetIterator, A.ListBase, A._Base64Decoder, A.Codec, A._Utf8Decoder, A._Enum, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.FormatException, A.MapEntry, A.Null, A._StringStackTrace, A.StringBuffer, A.ImmutableListMixin, A.FixedSizeListIterator, A.ByteReader, A._AppBinding_Object_SchedulerBinding, A.ConfigParams, A.DomNodeData, A.Renderer, A.JasprConfig, A.ComponentConfig, A.SchedulerBinding, A.SyncBinding, A.BuildOwner, A.ComponentsBinding, A.Component, A.Element, A._InactiveElements, A.RenderElement, A._SymmetricEdgeInsets, A._Unit, A._BoxStyles, A._$Index]);
    _inheritMany(J.Interceptor, [J.JSBool, J.JSNull, J.JavaScriptObject, J.JSNumber, J.JSString]);
    _inheritMany(J.JavaScriptObject, [J.LegacyJavaScriptObject, J.JSArray, A.NativeByteBuffer, A.NativeTypedData, A.EventTarget, A.DomException0, A.Event, A._HtmlCollection_JavaScriptObject_ListMixin, A.Location, A._NodeList_JavaScriptObject_ListMixin, A.__NamedNodeMap_JavaScriptObject_ListMixin]);
    ...
    _inheritMany(A.Converter, [A.CastConverter, A.Base64Decoder, A.JsonDecoder, A.Utf8Decoder, A.Decoder, A.StateDecoder, A.StateEncoder]);
    ...
    _inheritMany(A.Codec, [A.Encoding, A.JsonCodec, A.BinaryCodec, A.StateCodec]);
    ...
    _inheritMany(A.Component, [A._Root, A.DomComponent, A.Text, A.StatelessComponent]);
    _inheritMany(A.Element, [A.SingleChildElement, A.MultiChildElement, A.NoChildElement]);
    _inherit(A.__RootElement_SingleChildElement_RenderElement, A.SingleChildElement);
    _inherit(A._RootElement, A.__RootElement_SingleChildElement_RenderElement);
    _inheritMany(A.MultiChildElement, [A._DomElement_MultiChildElement_RenderElement, A.StatelessElement]);
    ...
    _inheritMany(A.StatelessComponent, [A._Index_StatelessComponent__$Index, A.SimpleCard]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "Null(@)", "Null()", "~(~())", "@()", "~(Element)", "Future<Null>()", "@(@)", "@(@,String)", "@(String)", "Null(~())", "~(@)", "Null(@,StackTrace)", "~(int,@)", "Null(Object,StackTrace)", "_Future<@>(@)", "~(Object?,Object?)", "~(String,EventBinding)", "String(MapEntry<String,String>)", "ComponentConfig(_ComponentConfig)", "Future<Null>?()", "Element?(Element)", "MapEntry<String,String>(String,String)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: Symbol("$ti")
  };
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"LegacyJavaScriptObject","UnknownJavaScriptObject":"LegacyJavaScriptObject","JavaScriptFunction":"LegacyJavaScriptObject","_ComponentConfig":"LegacyJavaScriptObject","_JasprConfig":"LegacyJavaScriptObject","MathMLElement":"Element0","AudioElement":"HtmlElement","MediaElement":"HtmlElement","HtmlDocument":"Node","Document":"Node","Window":"EventTarget","Comment":"CharacterData","HtmlFormControlsCollection":"HtmlCollection","CDataSection":"Text0","JSBool":{"bool":[],"TrustedGetRuntimeType":[]},"JSNull":{"Null":[],"TrustedGetRuntimeType":[]},"LegacyJavaScriptObject":{"_ComponentConfig":[]},"JSArray":{"List":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"]},"ArrayIterator":{"Iterator":["1"]},"JSNumber":{"double":[],"num":[]},"JSInt":{"double":[],"int":[],"num":[],"TrustedGetRuntimeType":[]},"JSNumNotInt":{"double":[],"num":[],"TrustedGetRuntimeType":[]},"JSString":{"String":[],"TrustedGetRuntimeType":[]},"CastConverter":{"Converter":["3","4"],"Converter.S":"3","Converter.T":"4"},"_CastIterableBase":{"Iterable":["2"]},"CastIterator":{"Iterator":["2"]},"CastIterable":{"_CastIterableBase":["1","2"],"Iterable":["2"],"Iterable.E":"2"},"_EfficientLengthCastIterable":{"CastIterable":["1","2"],"_CastIterableBase":["1","2"],"EfficientLengthIterable":["2"],"Iterable":["2"],"Iterable.E":"2"},"_CastListBase":{"ListBase":["2"],"List":["2"],"_CastIterableBase":["1","2"],"EfficientLengthIterable":["2"],"Iterable":["2"]},"CastList":{"_CastListBase":["1","2"],"ListBase":["2"],"List":["2"],"_CastIterableBase":["1","2"],"EfficientLengthIterable":["2"],"Iterable":["2"],"ListBase.E":"2","Iterable.E":"2"},"CastMap":{"MapBase":["3","4"],"Map":["3","4"],"MapBase.K":"3","MapBase.V":"4"},"LateError":{"Error":[]},"EfficientLengthIterable":{"Iterable":["1"]},"ListIterable":{"EfficientLengthIterable":["1"],"Iterable":["1"]},"SubListIterable":{"ListIterable":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"],"Iterable.E":"1","ListIterable.E":"1"},"ListIterator":{"Iterator":["1"]},"MappedIterable":{"Iterable":["2"],"Iterable.E":"2"},"EfficientLengthMappedIterable":{"MappedIterable":["1","2"],"EfficientLengthIterable":["2"],"Iterable":["2"],"Iterable.E":"2"},"MappedIterator":{"Iterator":["2"]},"MappedListIterable":{"ListIterable":["2"],"EfficientLengthIterable":["2"],"Iterable":["2"],"Iterable.E":"2","ListIterable.E":"2"},"NullError":{"TypeError":[],"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"Closure0Args":{"Function":[]},"Closure2Args":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"_CyclicInitializationError":{"Error":[]},"RuntimeError":{"Error":[]},"JsLinkedHashMap":{"MapBase":["1","2"],"Map":["1","2"],"MapBase.K":"1","MapBase.V":"2"},"LinkedHashMapKeyIterable":{"EfficientLengthIterable":["1"],"Iterable":["1"],"Iterable.E":"1"},"LinkedHashMapKeyIterator":{"Iterator":["1"]},"JSSyntaxRegExp":{"RegExp":[]},"NativeByteBuffer":{"TrustedGetRuntimeType":[]},"NativeByteData":{"TrustedGetRuntimeType":[]},"NativeTypedArray":{"JavaScriptIndexingBehavior":["1"]},"NativeTypedArrayOfInt":{"ListBase":["int"],"JavaScriptIndexingBehavior":["int"],"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"],"FixedLengthListMixin":["int"]},"NativeInt8List":{"ListBase":["int"],"JavaScriptIndexingBehavior":["int"],"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"],"FixedLengthListMixin":["int"],"TrustedGetRuntimeType":[],"ListBase.E":"int"},"NativeUint8List":{"ListBase":["int"],"Uint8List":[],"JavaScriptIndexingBehavior":["int"],"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"],"FixedLengthListMixin":["int"],"TrustedGetRuntimeType":[],"ListBase.E":"int"},"_Type":{"Type":[]},"_Error":{"Error":[]},"_TypeError":{"TypeError":[],"Error":[]},"_Future":{"Future":["1"]},"_SyncStarIterator":{"Iterator":["1"]},"_SyncStarIterable":{"Iterable":["1"],"Iterable.E":"1"},"AsyncError":{"Error":[]},"_Zone":{"Zone":[]},"_RootZone":{"_Zone":[],"Zone":[]},"_HashSet":{"SetBase":["1"],"Set":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"]},"_HashSetIterator":{"Iterator":["1"]},"_LinkedHashSet":{"SetBase":["1"],"Set":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"]},"_LinkedHashSetIterator":{"Iterator":["1"]},"ListBase":{"List":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"]},"MapBase":{"Map":["1","2"]},"SetBase":{"Set":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"]},"_SetBase":{"SetBase":["1"],"Set":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"]},"_JsonMap":{"MapBase":["String","@"],"Map":["String","@"],"MapBase.K":"String","MapBase.V":"@"},"_JsonMapKeyIterable":{"ListIterable":["String"],"EfficientLengthIterable":["String"],"Iterable":["String"],"Iterable.E":"String","ListIterable.E":"String"},"Base64Decoder":{"Converter":["String","List<int>"],"Converter.S":"String","Converter.T":"List<int>"},"Encoding":{"Codec":["String","List<int>"]},"JsonCodec":{"Codec":["Object?","String"],"Codec.T":"String"},"JsonDecoder":{"Converter":["String","Object?"],"Converter.S":"String","Converter.T":"Object?"},"Utf8Codec":{"Codec":["String","List<int>"],"Codec.T":"List<int>"},"Utf8Decoder":{"Converter":["List<int>","String"],"Converter.S":"List<int>","Converter.T":"String"},"int":{"num":[]},"List":{"EfficientLengthIterable":["1"],"Iterable":["1"]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"StateError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"OutOfMemoryError":{"Error":[]},"StackOverflowError":{"Error":[]},"_StringStackTrace":{"StackTrace":[]},"Node":{"EventTarget":[]},"HtmlElement":{"Element0":[],"Node":[],"EventTarget":[]},"AnchorElement":{"Element0":[],"Node":[],"EventTarget":[]},"AreaElement":{"Element0":[],"Node":[],"EventTarget":[]},"CharacterData":{"Node":[],"EventTarget":[]},"Element0":{"Node":[],"EventTarget":[]},"FormElement":{"Element0":[],"Node":[],"EventTarget":[]},"HtmlCollection":{"ListBase":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"EfficientLengthIterable":["Node"],"Iterable":["Node"],"ImmutableListMixin.E":"Node","ListBase.E":"Node"},"InputElement":{"Element0":[],"Node":[],"EventTarget":[]},"_ChildNodeListLazy":{"ListBase":["Node"],"List":["Node"],"EfficientLengthIterable":["Node"],"Iterable":["Node"],"ListBase.E":"Node"},"NodeList":{"ListBase":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"EfficientLengthIterable":["Node"],"Iterable":["Node"],"ImmutableListMixin.E":"Node","ListBase.E":"Node"},"SelectElement":{"Element0":[],"Node":[],"EventTarget":[]},"Text0":{"Node":[],"EventTarget":[]},"_Attr":{"Node":[],"EventTarget":[]},"_NamedNodeMap":{"ListBase":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"EfficientLengthIterable":["Node"],"Iterable":["Node"],"ImmutableListMixin.E":"Node","ListBase.E":"Node"},"_AttributeMap":{"MapBase":["String","String"],"Map":["String","String"]},"_ElementAttributeMap":{"MapBase":["String","String"],"Map":["String","String"],"MapBase.K":"String","MapBase.V":"String"},"FixedSizeListIterator":{"Iterator":["1"]},"BinaryCodec":{"Codec":["@","Uint8List"],"Codec.T":"Uint8List"},"Decoder":{"Converter":["Uint8List","@"],"Converter.S":"Uint8List","Converter.T":"@"},"BrowserAppBinding":{"AppBinding":[]},"BrowserDomRenderer":{"Renderer":[]},"StateCodec":{"Codec":["@","String"],"Codec.T":"String"},"StateDecoder":{"Converter":["String","@"],"Converter.S":"String","Converter.T":"@"},"StateEncoder":{"Converter":["@","String"],"Converter.S":"@","Converter.T":"String"},"Element":{"BuildContext":[]},"InheritedElement":{"Element":[],"BuildContext":[]},"ObserverElement":{"Element":[],"BuildContext":[]},"_Root":{"Component":[]},"_RootElement":{"RenderElement":[],"Element":[],"BuildContext":[]},"DomComponent":{"Component":[]},"DomElement":{"RenderElement":[],"Element":[],"BuildContext":[]},"Text":{"Component":[]},"NoChildElement":{"Element":[],"BuildContext":[]},"TextElement":{"RenderElement":[],"Element":[],"BuildContext":[]},"MultiChildElement":{"Element":[],"BuildContext":[]},"SingleChildElement":{"Element":[],"BuildContext":[]},"StatelessComponent":{"Component":[]},"StatelessElement":{"Element":[],"BuildContext":[]},"_SymmetricEdgeInsets":{"EdgeInsets":[]},"_Unit":{"Unit":[]},"_PixelsUnit":{"Unit":[]},"_BoxStyles":{"Styles":[]},"Index":{"StatelessComponent":[],"Component":[]},"SimpleCard":{"StatelessComponent":[],"Component":[]},"Int8List":{"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"]},"Uint8List":{"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"]}}'));
  A._Universe_addErasedTypes(init.typeUniverse, JSON.parse('{"__CastListBase__CastIterableBase_ListMixin":2,"NativeTypedArray":1,"_SetBase":1,"SyncState":1}'));
  var string$ = {
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "_queryReg", "$get$_queryReg", () => A.RegExp_RegExp("^(.*?)(?:\\((\\d+):(\\d+)\\))?$"));
  })();
...
//# sourceMappingURL=index.client.dart.js.map
