...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    BrowserDomRenderer_renderNode_closure: function BrowserDomRenderer_renderNode_closure(t0, t1, t2) {
      this.prevEventTypes = t0;
      this.dataEvents = t1;
      this.elem = t2;
    },
    BrowserDomRenderer_renderNode_closure0: function BrowserDomRenderer_renderNode_closure0(t0) {
      this.dataEvents = t0;
    },
    decodeConfig(config) {
      if (config == null)
    ...
    DomComponent$(child, events, tag) {
      return new A.DomComponent(tag, events, child, null);
    },
    ...
    DomComponent: function DomComponent(t0, t1, t2, t3) {
      var _ = this;
      _.tag = t0;
      _.events = t1;
      _._child = t2;
    ...
    Hello: function Hello(t0) {
      this.key = t0;
    },
    Hello_build_closure: function Hello_build_closure() {
    },
    ...
    Button_build_closure: function Button_build_closure(t0) {
      this.$this = t0;
    },
  ...
  A.BrowserDomRenderer.prototype = {
    renderNode$7(element, tag, id, classes, styles, attributes, events) {
      var data, attributesToRemove, elem, t1, toHydrate, t2, _i, e, nodes, old, t3, child, t4, prevEventTypes;
      ...
      if (J.get$isNotEmpty$ax(attributesToRemove._readLocal$0()))
      ...
      if (events != null && events.__js_helper$_length !== 0) {
        ...
        if (t1 == null)
          ...
          t2 = t1.$ti._eval$1("LinkedHashMapKeyIterable<1>");
        ...
        t1 = data.events;
        t1.toString;
        events.forEach$1(0, new A.BrowserDomRenderer_renderNode_closure(prevEventTypes, t1, elem));
        if (prevEventTypes != null)
          prevEventTypes.forEach$1(0, new A.BrowserDomRenderer_renderNode_closure0(t1));
      } else
        data.clearEvents$0();
    },
  ...
  A.DomElement.prototype = {
    ...
    renderNode$1(renderer) {
      ...
      t1._as(A.Element.prototype.get$component.call(_this));
      t1._as(A.Element.prototype.get$component.call(_this));
      renderer.renderNode$7(_this, t2.tag, _null, _null, _null, _null, t1._as(A.Element.prototype.get$component.call(_this)).events);
    }
  };
  A.Text.prototype = {
    createElement$0(_) {
  ...
  A.MultiChildElement.prototype = {
    ...
    performRebuild$0() {
      var e, st, exception, t1, t2, _this = this, built = null;
      try {
        built = J.toList$0$ax(_this.build$0());
      } catch (exception) {
        e = A.unwrapException(exception);
        st = A.getTraceFromException(exception);
        built = A._setArrayType([A.DomComponent$(new A.Text("Error on building component: " + A.S(e), null), null, "div")], type$.JSArray_Component);
  ...
  A.SingleChildElement.prototype = {
    ...
    performRebuild$0() {
      var e, st, exception, _this = this, built = null;
      try {
        built = type$._Root._as(A.Element.prototype.get$component.call(_this)).child;
      } catch (exception) {
        e = A.unwrapException(exception);
        st = A.getTraceFromException(exception);
        built = A.DomComponent$(new A.Text("Error on building component: " + A.S(e), null), null, "div");
        A.print("Error: " + A.S(e) + " " + A.S(st));
      } finally {
        _this._dirty = false;
      }
      _this._child = _this.updateChild$3(_this._child, built, null);
    },
    visitChildren$1(visitor) {
      var t1;
      type$.void_Function_Element._as(visitor);
  ...
  A.Hello.prototype = {
    build$1(context) {
      return new A._SyncStarIterable(this.build$body$Hello(context), type$._SyncStarIterable_Component);
    },
    build$body$Hello($async$context) {
      return function() {
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                $async$goto = 2;
                return $async$iterator._async$_current = new A.Button("Say Hi!", new A.Hello_build_closure(), null), 1;
              case 2:
                // after yield
                // implicit return
                return 0;
  ...
  A.Hello_build_closure.prototype = {
    call$0() {
      var t1 = window;
      t1.toString;
      B.Window_methods.alert$1(t1, "Hi!!");
      A.print("Hello World");
    },
    $signature: 0
  };
  A.Button.prototype = {
    build$1(context) {
      return new A._SyncStarIterable(this.build$body$Button(context), type$._SyncStarIterable_Component);
    },
    build$body$Button($async$context) {
      var $async$self = this;
      return function() {
        var context = $async$context;
        var $async$goto = 0, $async$handler = 1, $async$currentError;
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                $async$goto = 2;
                return $async$iterator._async$_current = A.DomComponent$(new A.Text($async$self.label, null), A.LinkedHashMap_LinkedHashMap$_literal(["click", new A.Button_build_closure($async$self)], type$.String, type$.void_Function_dynamic), "button"), 1;
              case 2:
                // after yield
                // implicit return
                return 0;
  ...
  A.Button_build_closure.prototype = {
    call$1(e) {
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Converter, A.Iterable, A.CastIterator, A.MapBase, A.Closure, A.Error, A.ListIterator, A.MappedIterator, A.FixedLengthListMixin, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.ExceptionAndStackTrace, A._StackTrace, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.JSSyntaxRegExp, A._MatchImplementation, A._Cell, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A._AsyncAwaitCompleter, A._SyncStarIterator, A.AsyncError, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A._StreamIterator, A._Zone, A.SetBase, A._HashSetIterator, A._LinkedHashSetCell, A._LinkedHashSetIterator, A.ListBase, A._Base64Decoder, A.Codec, A._Utf8Decoder, A._Enum, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.FormatException, A.Null, A._StringStackTrace, A.StringBuffer, A.Events, A._EventStreamSubscription, A.ImmutableListMixin, A.FixedSizeListIterator, A.ByteReader, A._AppBinding_Object_SchedulerBinding, A.ConfigParams, A.DomNodeData, A.EventBinding, A.Renderer, A.JasprConfig, A.ComponentConfig, A.SchedulerBinding, A.SyncBinding, A.BuildOwner, A.ComponentsBinding, A.Component, A.Element, A._InactiveElements, A.RenderElement, A._$Hello]);
    ...
    _inheritMany(A.Closure, [A.Closure2Args, A.Closure0Args, A.TearOffClosure, A.JsLinkedHashMap_values_closure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A._Future__chainForeignFuture_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A._EventStreamSubscription_closure, A.EventBinding_closure, A.BrowserDomRenderer_renderNode_closure0, A.JasprConfig_comp_closure, A.ComponentsBinding_attachRootComponent__closure, A.Element__updateAncestorSiblingRecursively_closure, A.MultiChildElement_updateChildren_replaceWithNullIfForgotten, A.Button_build_closure]);
    _inheritMany(A.Closure2Args, [A.CastMap_forEach_closure, A.JsLinkedHashMap_addAll_closure, A.initHooks_closure0, A._awaitOnObject_closure0, A._wrapJsFunctionForAsync_closure, A._Future__chainForeignFuture_closure0, A.MapBase_mapToString_closure, A.DomNodeData_clearEvents_closure, A.BrowserDomRenderer_renderNode_closure]);
    ...
    _inheritMany(A.StatelessComponent, [A._Hello_StatelessComponent__$Hello, A.Button]);
...
//# sourceMappingURL=hello.client.dart.js.map
